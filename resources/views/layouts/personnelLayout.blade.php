...
<body>
	...
	<div class="vertical-nav" id="vertical-nav-toggle">
		<div class="nav-logo bg-white p-4">
  		...
  		<ul class="nav">
			<p class="nav-text text-white m-0">{{ Auth::user()->username }} <br> <span class="small">&bull; {{ $position }}</span> <br> <a href="{{ route('profile.edit') }}" class="text-decoration-none">Edit Profile</a></p>
			<li class="nav-item">
