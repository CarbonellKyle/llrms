...
<div id="content" class="content-wrapper p-3">
  	...
  	<h1 class="text-dark">{{ __('Dashboard') }}</h1>
		<div class="row">
			<div class="col-12">
                <div class="alert alert-info alert-dismissible fade show" role="alert">
                    You've successfully logged in as a <strong>Personnel</strong>!
...
<!-- <div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Personnel Dashboard') }}</div>
                ...
                <div class="card-body">
                    ...
                    <p>Welcome, <strong>{{ Auth::user()->username }}</strong>! You are Logged in as a <strong>Personnel</strong>!</p>
                </div>
            </div>
        </div>
    </div>
